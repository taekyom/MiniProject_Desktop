...
namespace WpfSMSApp.View.User
{
    ...
    public partial class EditUser : Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                LblUserIdentityNumber.Visibility = LblUserSurName.Visibility = 
                    ...
                    LblUserPassword.Visibility = LblUserActivated.Visibility =
                    LblUserAdmin.Visibility = Visibility.Hidden;
        ...
        public bool IsValidInput()
        {
            ...
            {
                var cnt = Logic.DataAccess.GetUsers().Where(u => u.UserIdentityNumber.Equals(TxtUserEmail.Text)).Count();
                if (cnt > 0)
                {
        ...
        private void BtnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            var user = GrdData.SelectedItem as Model.User; //같은 데이터 들어가지 않도록
        ...
        private void GrdData_SelectedCellsChanged(object sender, SelectedCellsChangedEventArgs e)
        {
            try
            {
                ...
                CboUserAdmin.SelectedIndex = user.UserActivated == false ? 0 : 1;
